...
class KANLayers_MLP(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, drop=0.):
        ...
        hidden_features = 24 # Raw
        #hidden_features = 32  # 2D
        self.dim = in_features
        self.hidden_features = hidden_features

        self.conv1 = nn.Conv2d(in_features, hidden_features, kernel_size=3, stride=1, padding=1)
        self.fc1 = ConvKAN(hidden_features, hidden_features, padding=0, kernel_size=1, stride=1,) # Raw
        self.fc2 = ConvKAN(hidden_features, out_features, padding=0, kernel_size=1, stride=1,)
