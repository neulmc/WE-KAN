_base_ = [
    '../_base_/datasets/challenge_bs8_600.py', '../_base_/schedules/schedule_3x_adamwn.py',
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox=dict(type='RotatedIoULoss', loss_weight=1.5),
        loss_angle=None,
        loss_centerness=dict(
            type='mmdet.CrossEntropyLoss', use_sigmoid=True, loss_weight=1.0),
        loss_kan=dict(  # lmc KAN new
            type='KANIdenty', loss_weight=0.01),
        kan=True,  # lmc KAN
