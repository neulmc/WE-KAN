_base_ = [
    '../_base_/datasets/challenge_bs8_600.py', '../_base_/schedules/schedule_1x.py',
...
model = dict(
    ...
    bbox_head=dict(
        type='RotatedFCOSHead_nbnew_tank',
        num_classes=6,
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
        ...
        loss_kan=dict(  # lmc KAN
            type='KANIdenty', loss_weight=0.1),
        kan=True,  # lmc KAN
